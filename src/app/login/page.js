    ...
    <main className="min-h-[85vh] flex items-center justify-center p-6 bg-gradient-to-br from-[#FAF9F6] to-[#F0EFEA] py-12 sm:py-20">
      <div className="bg-white border border-black/5 rounded-none overflow-hidden shadow-2xl max-w-5xl w-full min-h-[600px] grid grid-cols-1 md:grid-cols-12 g-0">
        ...
        <div className="md:col-span-5 text-white p-8 sm:p-12 flex flex-col justify-center relative select-none overflow-hidden min-h-[300px] md:min-h-auto">
          {/* Background Image */}
          <img 
            src="/images/campaigns/auth-login.jpeg" 
          ...
          <div className="relative z-20">
            <span className="text-white/80 font-bold uppercase tracking-[0.25em] text-[10px] mb-2 block font-sans">Welcome Back</span>
            <h2 className="text-2xl font-black text-white mb-4 tracking-widest font-sans uppercase">AURA THREADS</h2>
            <p className="text-white/80 text-xs leading-relaxed mb-8 font-sans max-w-xs">Unlock custom designer inventory listings, secure quick checkout, and elite AuraSelect membership access.</p>
            <div>
        ...
        <div className="md:col-span-7 p-8 sm:p-12 flex flex-col justify-center">
          <div className="mb-6">
            <span className="text-[9px] font-bold text-neutral-400 uppercase tracking-[0.25em] font-sans">SECURE ACCESS</span>
            <h3 className="text-xl font-black font-sans uppercase mb-1 text-black tracking-wide mt-1">Sign In</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5 font-sans">
                ...
                <a href="#" className="text-[10px] text-stone hover:text-black font-bold uppercase tracking-widest">Forgot?</a>
              </div>
              <input
                type="password"
                required
            ...
            <p className="text-center text-xs text-neutral-500 pt-2 font-sans uppercase tracking-wider">
              Don't have an account? <Link href="/signup" className="text-black font-bold hover:underline transition-colors ml-1">Sign Up</Link>
            </p>
          </form>

...
export default function AccessoriesPage() {
  ...
  const getSubcategory = (p) => {
    ...
    if (id.includes("bag") || id === "m28" || id === "m29") return "Bags";
    if (id.includes("cap") || id === "m25" || id === "m26") return "Caps";
    if (id.includes("sunglasses") || id === "m27" || id === "m30" || id === "m31") return "Sunglasses";
    return "Others";
  };

  const accessories = products.filter(p => p.category && p.category.toLowerCase() === "accessories");
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <aside className="w-full md:w-64 shrink-0">
          <div className="bg-white border border-black/10 rounded-none p-6 sticky top-28 shadow-sm">
            ...
            {/* Type Filter */}
            <div>
              <h5 className="font-bold text-[10px] uppercase tracking-widest mb-4 font-sans text-black">Accessory Type</h5>
              <select
        ...
        <section className="flex-grow">
          <div className="mb-6 border-b border-black/5 pb-4">
            <span className="text-[9px] font-bold text-stone uppercase tracking-[0.25em] font-sans">ESSENTIAL COMPLEMENTS</span>
            <h1 className="text-2xl font-black font-sans tracking-wider mb-1 uppercase text-black">STUDIO ACCENTS</h1>
          ...
          {filtered.length > 0 ? (
            ...
            <div className="text-center py-20 bg-white border border-black/10 rounded-none shadow-sm">
              ...
              <p className="text-stone text-sm">No accessories match your selected filters.</p>
              <button 
                onClick={resetFilters} 
